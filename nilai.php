          ...
          <div class="card shadow mb-4">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <input type="text" name="plat"  value="<?php echo $row_edit['plat'];?>" class="form-control" placeholder="Plat Motor">
                               
                    <input type="text" name="merk"  value="<?php echo $row_edit['merk'];?>" class="form-control" placeholder="Merk">

                    <input type="text" name="tipe"  value="<?php echo $row_edit['tipe'];?>" class="form-control" placeholder="Tipe">
